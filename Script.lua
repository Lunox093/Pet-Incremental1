...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = true,
       Invite = "gbVWxRFtqt", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
       ...
       Key = {"https://pastebin.com/raw/kudCasSy"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
